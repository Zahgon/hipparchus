 ...
 */
public class Line implements Hyperplane<Euclidean2D, Vector2D, Line, SubLine>, Embedding<Euclidean2D, Vector2D, Euclidean1D, Vector1D> {
     ...
     */
    public static Transform<Euclidean2D, Vector2D, Line, SubLine, Euclidean1D, Vector1D, OrientedPoint, SubOrientedPoint> getTransform(final double cXX, final double cYX, final double cXY, final double cYY, final double cX1, final double cY1) throws MathIllegalArgumentException {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * polygon)./<p>
     */
    private static class LineTransform implements Transform<Euclidean2D, Vector2D, Line, SubLine, Euclidean1D, Vector1D, OrientedPoint, SubOrientedPoint> {
