...
public enum RotationOrder {
     ...
     * @since 3.1
     */
    private Vector3D getColumnVector(final Rotation rotation, final RotationConvention convention) {
        return rotation.applyTo(convention == RotationConvention.VECTOR_OPERATOR ? stage3.getAxis() : stage1.getAxis());
    }
     ...
     * @since 3.1
     */
    private Vector3D getRowVector(final Rotation rotation, final RotationConvention convention) {
        return rotation.applyInverseTo(convention == RotationConvention.VECTOR_OPERATOR ? stage1.getAxis() : stage3.getAxis());
    }
     ...
     * @since 3.1
     */
    private <T extends CalculusFieldElement<T>> FieldVector3D<T> getColumnVector(final FieldRotation<T> rotation, final RotationConvention convention) {
        return rotation.applyTo(convention == RotationConvention.VECTOR_OPERATOR ? stage3.getAxis() : stage1.getAxis());
    }
     ...
     * @since 3.1
     */
    private <T extends CalculusFieldElement<T>> FieldVector3D<T> getRowVector(final FieldRotation<T> rotation, final RotationConvention convention) {
        return rotation.applyInverseTo(convention == RotationConvention.VECTOR_OPERATOR ? stage1.getAxis() : stage3.getAxis());
    }
     ...
     * @since 3.1
     */
    private static <T extends CalculusFieldElement<T>> T safeAcos(final T cos, final T sin1, final T sin2) {
     ...
     * @since 3.1
     */
    private static <T extends CalculusFieldElement<T>> T safeAsin(final T sin, final T cos1, final T cos2) {
