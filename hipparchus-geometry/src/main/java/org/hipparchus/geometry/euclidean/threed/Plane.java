 ...
 */
public class Plane implements Hyperplane<Euclidean3D, Vector3D, Plane, SubPlane>, Embedding<Euclidean3D, Vector3D, Euclidean2D, Vector2D> {
     ...
     */
    public Plane(final Vector3D normal, final double tolerance) throws MathRuntimeException {
        setNormal(normal);
     ...
     * @exception MathRuntimeException if the normal norm is too small
     */
    public Plane(final Vector3D p, final Vector3D normal, final double tolerance) throws MathRuntimeException {
        setNormal(normal);
        this.tolerance = tolerance;
     ...
     */
    public Plane(final Vector3D p1, final Vector3D p2, final Vector3D p3, final double tolerance) throws MathRuntimeException {
