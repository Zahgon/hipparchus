...
public class RegionFactory<S extends Space, P extends Point<S, P>, H extends Hyperplane<S, P, H, I>, I extends SubHyperplane<S, P, H, I>> {
     ...
     * @return new tree, complement of the node
     */
    private BSPTree<S, P, H, I> recurseComplement(final BSPTree<S, P, H, I> node, final Map<BSPTree<S, P, H, I>, BSPTree<S, P, H, I>> map) {
    ...
    private class UnionMerger implements BSPTree.LeafMerger<S, P, H, I> {
         ...
         */
        @Override
        public BSPTree<S, P, H, I> merge(final BSPTree<S, P, H, I> leaf, final BSPTree<S, P, H, I> tree, final BSPTree<S, P, H, I> parentTree, final boolean isPlusChild, final boolean leafFromInstance) {
            throw new UnsupportedOperationException("STUB: not implemented");
        }
    }
