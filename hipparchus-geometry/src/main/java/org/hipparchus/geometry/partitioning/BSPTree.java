...
public class BSPTree<S extends Space, P extends Point<S, P>, H extends Hyperplane<S, P, H, I>, I extends SubHyperplane<S, P, H, I>> {
     ...
     * @see #insertCut
     */
    public BSPTree(final I cut, final BSPTree<S, P, H, I> plus, final BSPTree<S, P, H, I> minus, final Object attribute) {
        this.cut = cut;
        this.plus = plus;
        this.minus = minus;
        this.parent = null;
     ...
     */
    public boolean insertCut(final H hyperplane) {
     ...
     */
    public void visit(final BSPTreeVisitor<S, P, H, I> visitor) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * since all connections have already been established
     */
    private BSPTree<S, P, H, I> merge(final BSPTree<S, P, H, I> tree, final LeafMerger<S, P, H, I> leafMerger, final BSPTree<S, P, H, I> parentTree, final boolean isPlusChild) {
        if (cut == null) {
            // cell/tree operation
     ...
     * @param <I> Type of the sub-hyperplane.
     */
    public interface LeafMerger<S extends Space, P extends Point<S, P>, H extends Hyperplane<S, P, H, I>, I extends SubHyperplane<S, P, H, I>> {
         ...
         * the arguments)
         */
        BSPTree<S, P, H, I> merge(BSPTree<S, P, H, I> leaf, BSPTree<S, P, H, I> tree, BSPTree<S, P, H, I> parentTree, boolean isPlusChild, boolean leafFromInstance);
    }
     ...
     * @param <I> Type of the sub-hyperplane.
     */
    public interface VanishingCutHandler<S extends Space, P extends Point<S, P>, H extends Hyperplane<S, P, H, I>, I extends SubHyperplane<S, P, H, I>> {
     ...
     */
    public BSPTree<S, P, H, I> split(final I sub) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * @see LeafMerger
     */
    public void insertInTree(final BSPTree<S, P, H, I> parentTree, final boolean isPlusChild, final VanishingCutHandler<S, P, H, I> vanishingHandler) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public BSPTree<S, P, H, I> pruneAroundConvexCell(final Object cellAttribute, final Object otherLeafsAttributes, final Object internalAttributes) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
