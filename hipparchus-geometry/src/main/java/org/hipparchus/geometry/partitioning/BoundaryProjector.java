 ...
 */
class BoundaryProjector<S extends Space, P extends Point<S, P>, H extends Hyperplane<S, P, H, I>, I extends SubHyperplane<S, P, H, I>, T extends Space, Q extends Point<T, Q>, F extends Hyperplane<T, Q, F, J>, J extends SubHyperplane<T, Q, F, J>> implements BSPTreeVisitor<S, P, H, I> {
     ...
     */
    private boolean belongsToPart(final P point, final Hyperplane<S, P, H, I> hyperplane, final Region<T, Q, F, J> part) {
     ...
     */
    private P singularProjection(final P point, final Hyperplane<S, P, H, I> hyperplane, final Region<T, Q, F, J> part) {
        // there is a non-null sub-space, we can dive into smaller dimensions
        @SuppressWarnings("unchecked")
        final Embedding<S, P, T, Q> embedding = (Embedding<S, P, T, Q>) hyperplane;
