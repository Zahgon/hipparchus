 ...
 */
public class NodesSet<S extends Space, P extends Point<S, P>, H extends Hyperplane<S, P, H, I>, I extends SubHyperplane<S, P, H, I>> implements Iterable<BSPTree<S, P, H, I>> {
