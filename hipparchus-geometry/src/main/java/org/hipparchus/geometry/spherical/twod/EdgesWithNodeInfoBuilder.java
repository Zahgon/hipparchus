...
class EdgesWithNodeInfoBuilder implements BSPTreeVisitor<Sphere2D, S2Point, Circle, SubCircle> {
     ...
     */
    private void addContribution(final SubCircle sub, final BSPTree<Sphere2D, S2Point, Circle, SubCircle> node, final Iterable<BSPTree<Sphere2D, S2Point, Circle, SubCircle>> splitters, final boolean reversed) {
     ...
     */
    private BSPTree<Sphere2D, S2Point, Circle, SubCircle> selectClosest(final S2Point point, final Iterable<BSPTree<Sphere2D, S2Point, Circle, SubCircle>> candidates) {
        if (point == null) {
            return null;
        }
