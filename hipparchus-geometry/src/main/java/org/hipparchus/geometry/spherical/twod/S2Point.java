...
public class S2Point implements Point<Sphere2D, S2Point> {
     ...
     */
    public S2Point(final double theta, final double phi) throws MathIllegalArgumentException {
     ...
     * @exception MathIllegalArgumentException if \( \varphi \) is not in the [\( 0; \pi \)] range
     */
    private static Vector3D vector(final double theta, final double phi) throws MathIllegalArgumentException {
