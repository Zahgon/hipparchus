 ...
 * </p>
 */
public class ArcsSet extends AbstractRegion<Sphere1D, S1Point, LimitAngle, SubLimitAngle, Sphere1D, S1Point, LimitAngle, SubLimitAngle> implements Iterable<double[]> {
     ...
     */
    public ArcsSet(final double tolerance) throws MathIllegalArgumentException {
        super(tolerance);
     ...
     */
    public ArcsSet(final double lower, final double upper, final double tolerance) throws MathIllegalArgumentException {
     ...
     * @exception MathIllegalArgumentException if tolerance is smaller than {@link Sphere1D#SMALLEST_TOLERANCE}
     */
    public ArcsSet(final BSPTree<Sphere1D, S1Point, LimitAngle, SubLimitAngle> tree, final double tolerance) throws InconsistentStateAt2PiWrapping, MathIllegalArgumentException {
     ...
     * @exception MathIllegalArgumentException if tolerance is smaller than {@link Sphere1D#SMALLEST_TOLERANCE}
     */
    public ArcsSet(final Collection<SubLimitAngle> boundary, final double tolerance) throws InconsistentStateAt2PiWrapping, MathIllegalArgumentException {
     ...
     * or tolerance is smaller than {@link Sphere1D#SMALLEST_TOLERANCE}
     */
    private static BSPTree<Sphere1D, S1Point, LimitAngle, SubLimitAngle> buildTree(final double lower, final double upper, final double tolerance) throws MathIllegalArgumentException {
        Sphere1D.checkTolerance(tolerance);
        ...
        if (normalizedUpper <= MathUtils.TWO_PI) {
            ...
            return new BSPTree<>(lowerCut, new BSPTree<>(upperCut, new BSPTree<>(Boolean.FALSE), new BSPTree<>(Boolean.TRUE), null), new BSPTree<>(Boolean.TRUE), null);
        }
    }
     ...
     */
    private BSPTree<Sphere1D, S1Point, LimitAngle, SubLimitAngle> getFirstLeaf(final BSPTree<Sphere1D, S1Point, LimitAngle, SubLimitAngle> root) {
        if (root.getCut() == null) {
            return root;
        }
     ...
     */
    private BSPTree<Sphere1D, S1Point, LimitAngle, SubLimitAngle> getLastLeaf(final BSPTree<Sphere1D, S1Point, LimitAngle, SubLimitAngle> root) {
        if (root.getCut() == null) {
            return root;
        }
     ...
     */
    private BSPTree<Sphere1D, S1Point, LimitAngle, SubLimitAngle> nextInternalNode(BSPTree<Sphere1D, S1Point, LimitAngle, SubLimitAngle> node) {
     ...
     */
    private BSPTree<Sphere1D, S1Point, LimitAngle, SubLimitAngle> previousInternalNode(BSPTree<Sphere1D, S1Point, LimitAngle, SubLimitAngle> node) {
     ...
     */
    private BSPTree<Sphere1D, S1Point, LimitAngle, SubLimitAngle> leafBefore(BSPTree<Sphere1D, S1Point, LimitAngle, SubLimitAngle> node) {
     ...
     */
    private BSPTree<Sphere1D, S1Point, LimitAngle, SubLimitAngle> leafAfter(BSPTree<Sphere1D, S1Point, LimitAngle, SubLimitAngle> node) {
        node = childAfter(node);
        while (node.getCut() != null) {
            node = childBefore(node);
        }
     ...
     */
    private BSPTree<Sphere1D, S1Point, LimitAngle, SubLimitAngle> childBefore(BSPTree<Sphere1D, S1Point, LimitAngle, SubLimitAngle> node) {
        if (isDirect(node)) {
     ...
     */
    private BSPTree<Sphere1D, S1Point, LimitAngle, SubLimitAngle> childAfter(BSPTree<Sphere1D, S1Point, LimitAngle, SubLimitAngle> node) {
        if (isDirect(node)) {
            // smaller angles are on minus side, larger angles are on plus side
            return node.getPlus();
        } else {
     ...
     */
    private void addArcLimit(final BSPTree<Sphere1D, S1Point, LimitAngle, SubLimitAngle> tree, final double alpha, final boolean isStart) {
