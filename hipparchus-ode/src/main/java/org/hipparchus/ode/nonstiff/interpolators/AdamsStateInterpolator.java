...
public class AdamsStateInterpolator extends AbstractODEStateInterpolator {
     ...
     */
    public AdamsStateInterpolator(final double stepSize, final ODEStateAndDerivative reference, final double[] scaled, final Array2DRowRealMatrix nordsieck, final boolean isForward, final ODEStateAndDerivative globalPreviousState, final ODEStateAndDerivative globalCurrentState, final EquationsMapper equationsMapper) {
     ...
     */
    @Override
    protected ODEStateAndDerivative computeInterpolatedStateAndDerivatives(final EquationsMapper equationsMapper, final double time, final double theta, final double thetaH, final double oneMinusThetaH) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    public static ODEStateAndDerivative taylor(final EquationsMapper equationsMapper, final ODEStateAndDerivative reference, final double time, final double stepSize, final double[] scaled, final Array2DRowRealMatrix nordsieck) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
}
