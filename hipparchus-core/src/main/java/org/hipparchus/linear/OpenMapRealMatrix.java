...
public class OpenMapRealMatrix extends AbstractRealMatrix implements SparseRealMatrix, Serializable {
    ...
    public OpenMapRealMatrix(int rowDimension, int columnDimension) throws MathIllegalArgumentException {
        ...
        if (lRow * lCol >= Integer.MAX_VALUE) {
            throw new MathIllegalArgumentException(LocalizedCoreFormats.NUMBER_TOO_LARGE_BOUND_EXCLUDED, lRow * lCol, Integer.MAX_VALUE);
        }
     ...
     */
    @Override
    public OpenMapRealMatrix subtract(final RealMatrix m) throws MathIllegalArgumentException {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     */
    @Override
    public RealMatrix transposeMultiply(final RealMatrix m) throws MathIllegalArgumentException {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
