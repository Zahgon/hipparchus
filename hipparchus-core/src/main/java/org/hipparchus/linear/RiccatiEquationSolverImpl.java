...
public class RiccatiEquationSolverImpl implements RiccatiEquationSolver {
     ...
     */
    public RiccatiEquationSolverImpl(final RealMatrix A, final RealMatrix B, final RealMatrix Q, final RealMatrix R) {
        // checking A
        if (!A.isSquare()) {
     ...
     */
    private RealMatrix computeP(final RealMatrix A, final RealMatrix B, final RealMatrix Q, final RealMatrix R, final RealMatrix R_inv, final int maxIterations, final double epsilon) {
     ...
     */
    private RealMatrix computeInitialP(final RealMatrix A, final RealMatrix B, final RealMatrix Q, final RealMatrix R_inv) {
        ...
        // defining M
        final RealMatrix m = MatrixUtils.createRealMatrix(m11.getRowDimension() + m21.getRowDimension(), m11.getColumnDimension() + m12.getColumnDimension());
        ...
        final OrderedComplexEigenDecomposition eigenDecomposition = new OrderedComplexEigenDecomposition(m, EPSILON, ComplexEigenDecomposition.DEFAULT_EPSILON, ComplexEigenDecomposition.DEFAULT_EPSILON_AV_VD_CHECK);
        final FieldMatrix<Complex> u = eigenDecomposition.getV();
        // solving linear system
        // P = U_21*U_11^-1
        final FieldMatrix<Complex> u11 = u.getSubMatrix(0, m11.getRowDimension() - 1, 0, m11.getColumnDimension() - 1);
        final FieldMatrix<Complex> u21 = u.getSubMatrix(m11.getRowDimension(), 2 * m11.getRowDimension() - 1, 0, m11.getColumnDimension() - 1);
     ...
     */
    private RealMatrix approximateP(final RealMatrix A, final RealMatrix B, final RealMatrix Q, final RealMatrix R, final RealMatrix R_inv, final RealMatrix initialP, final int maxIterations, final double epsilon) {
        ...
        while (error > epsilon) {
            ...
            final Array2DRowRealMatrix eyeX = (Array2DRowRealMatrix) MatrixUtils.createRealIdentityMatrix(X_.getRowDimension());
