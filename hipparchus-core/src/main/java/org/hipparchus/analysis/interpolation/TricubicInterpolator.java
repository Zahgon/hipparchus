...
public class TricubicInterpolator implements TrivariateGridInterpolator {
     ...
     */
    @Override
    public TricubicInterpolatingFunction interpolate(final double[] xval, final double[] yval, final double[] zval, final double[][][] fval) throws MathIllegalArgumentException {
