 ...
 */
public class PiecewiseBicubicSplineInterpolatingFunction implements BivariateFunction, FieldBivariateFunction {
     ...
     *         height of f
     */
    public PiecewiseBicubicSplineInterpolatingFunction(double[] x, double[] y, double[][] f) throws MathIllegalArgumentException, NullArgumentException {
        ...
        if (yLen != f[0].length) {
            throw new MathIllegalArgumentException(LocalizedCoreFormats.DIMENSIONS_MISMATCH, yLen, f[0].length);
        }
     ...
     */
    @Override
    public <T extends CalculusFieldElement<T>> T value(final T x, final T y) throws MathIllegalArgumentException {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
