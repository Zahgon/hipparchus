...
public final class RyuDouble {
    ...
    private static long mulPow5divPow2(final long m, final int i, final int j) {
        ...
        // 124
        long bits13 = mHigh * POW5_SPLIT[i][0];
        // 93
        long bits03 = mLow * POW5_SPLIT[i][0];
        // 93
        long bits12 = mHigh * POW5_SPLIT[i][1];
        // 62
        long bits02 = mLow * POW5_SPLIT[i][1];
        // 62
        long bits11 = mHigh * POW5_SPLIT[i][2];
        // 31
        long bits01 = mLow * POW5_SPLIT[i][2];
        // 31
        long bits10 = mHigh * POW5_SPLIT[i][3];
        // 0
        long bits00 = mLow * POW5_SPLIT[i][3];
        int actualShift = j - 3 * 31 - 21;
        if (actualShift < 0) {
            throw new MathIllegalArgumentException(LocalizedCoreFormats.NUMBER_TOO_SMALL, j, 3 * 31 + 21);
        }
