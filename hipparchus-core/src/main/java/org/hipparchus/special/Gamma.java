...
public class Gamma {
     ...
     */
    // NOPMD - the fact the function and the constant have the same name is intentional and comes from mathematics conventions
     ...
     * @throws MathIllegalStateException if the algorithm fails to converge.
     */
    public static <T extends CalculusFieldElement<T>> T regularizedGammaQ(final T a, T x, double epsilon, int maxIterations) {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * @throws MathIllegalArgumentException if {@code x > 1.5}.
     */
    public static double logGamma1p(final double x) throws MathIllegalArgumentException {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
     ...
     * @throws MathIllegalArgumentException if {@code x > 1.5}.
     */
    public static <T extends CalculusFieldElement<T>> T logGamma1p(final T x) throws MathIllegalArgumentException {
        throw new UnsupportedOperationException("STUB: not implemented");
    }
