...
public class Beta {
     ...
     */
    private static double logGammaSum(final double a, final double b) throws MathIllegalArgumentException {
     ...
     */
    private static double logGammaMinusLogGammaSum(final double a, final double b) throws MathIllegalArgumentException {
        if (a < 0.0) {
            throw new MathIllegalArgumentException(LocalizedCoreFormats.NUMBER_TOO_SMALL, a, 0.0);
        }
        if (b < 10.0) {
            throw new MathIllegalArgumentException(LocalizedCoreFormats.NUMBER_TOO_SMALL, b, 10.0);
        }
        /*
         * d = a + b - 0.5
         */
     ...
     */
    private static double deltaMinusDeltaSum(final double a, final double b) throws MathIllegalArgumentException {
        MathUtils.checkRangeInclusive(a, 0, b);
        if (b < 10) {
            throw new MathIllegalArgumentException(LocalizedCoreFormats.NUMBER_TOO_SMALL, b, 10);
        }
        final double h = a / b;
    ...
    private static double sumDeltaMinusDeltaSum(final double p, final double q) {
        if (p < 10.0) {
            throw new MathIllegalArgumentException(LocalizedCoreFormats.NUMBER_TOO_SMALL, p, 10.0);
        }
        if (q < 10.0) {
            throw new MathIllegalArgumentException(LocalizedCoreFormats.NUMBER_TOO_SMALL, q, 10.0);
        }
